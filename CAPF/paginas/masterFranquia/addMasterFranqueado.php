...
<head>
	...
	<meta charset="UTF-8">
	<title>Include MasterFranqueados do Brasil</title>
...
<body>
    ...
    if(isset($_POST['submit'])) {
        ...
        if($nomer==""||$nomef==""||$idusu2==""||$regfran=="") {  
            ...
            mysqli_query($mysqli, "INSERT INTO franqueado VALUES('', '$nomer', '$nomef', '$numero', '$end', '$telf', '$telr', '$cep')")
                or die("Could not execute the insert query.");   

            $result3 = mysqli_query($mysqli, "SELECT *FROM franqueado WHERE nome_franquia='$nomef'")
                or die("Could not execute the insert query.");
            $res3 = mysqli_fetch_array($result3);
            $idfranq = $res3['id_franqueado'];

            mysqli_query($mysqli, "INSERT INTO masterfranquia VALUES('$idfranq', '$regfran', '$idusu2')")
                or die("Could not execute the insert query.");
