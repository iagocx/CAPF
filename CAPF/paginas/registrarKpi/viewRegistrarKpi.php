                    ...
                    <?php
                        if(isset($_POST['submit'])) {
                            while($res7 = mysqli_fetch_array($result7)) {//tabela kpi
                                ...
                                $aux7 = $res7['CategoriaKpi_id_categoria'];//kpi.categoria_kpi

                                $result10 = mysqli_query($mysqli,//
                                "SELECT * FROM categoriakpi 
                                WHERE id_categoria='$aux7'");
                                ...
                                if(mysqli_num_rows($result2) >0){//SELECT registroKpi; nao retornou vazio registro
                                    if($res2['status'] == 'R'){//se existe, status R
                                        ...
                                        echo "<td><a href=\"registrarKpi.php?id=$res7[id_kpi]&&case=1&&nome1=$aux1
                                    &&nome1=$aux1&&nome2=$aux3&&dataref=$dataMesAno&&datareg=$dataAtual&&nomemf=$aux6
                                    &&meta=$res7[valorMeta]&&id1=$aux&&idreg=$res2[id_registro]\">Editar</a></td>";
                                        echo "</tr>";
                                        //deixa editar valor
                                        ...
                                        echo "<td>".$res2['dataEnvio']."</td>";
                                        echo "<td>".$res2['mesAnoReferencia']."</td>";
                                        echo "<td>".$statusString."</td>";//status
                                        ...
                                        echo "<td></td>";
                                        echo "<td></td>";
                                        echo "<td><a href=\"registrarKpi.php?id=$res7[id_kpi]&&case=2&&nome1=$aux1
                                    &&nome1=$aux1&&nome2=$aux3&&dataref=$dataMesAno&&datareg=$dataAtual&&nomemf=$aux6
                                    &&meta=$res7[valorMeta]&&id1=$aux\">Registrar</a></td>";
                                        echo "</tr>";
                                    }
                                }else{//0 registros
                                    echo "<tr>";
                                    ...
                                    echo "<td></td>";
                                    echo "<td></td>";
                                    echo "<td><a href=\"registrarKpi.php?id=$res7[id_kpi]&&case=3&&nome1=$aux1
                                    &&nome1=$aux1&&nome2=$aux3&&dataref=$dataMesAno&&datareg=$dataAtual&&nomemf=$aux6
                                    &&meta=$res7[valorMeta]&&id1=$aux\">Registrar</a></td>";	
