...
$result = mysqli_query($mysqli, "SELECT * FROM usuario where tipo='3' ORDER BY nome");
...
<head>
	...
	<meta charset="UTF-8">
	<title>Manter usuários franqueados</title>
            ...
            <!-- Titulo da sessão -->
                ...
                <div class="title-section">
                    <span class="sub-title">
                        Lista de <span>Usuários</span> franqueados
                </div>
                <div class="tb-scrol">
                    <table>
                        <tr>
                        ...
                        <?php
                            while($res = mysqli_fetch_array($result)) {	
                                ...
                                echo "<td><a href=\"editusuariosFranqueados.php?id=$res[cpf]&&nom=$res[nome]\">Edit</a></td>";
                                echo "<td><a href=\"delusuariosFranqueados.php?id=$res[cpf]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";		
                                echo "</tr>";
                            }
                        ?>   
                    </table>
                ...
                <div class="btn-sv">
                    <a href="./addusuariosFranqueados.php">
